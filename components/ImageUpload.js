      ...
      <div className="w-full h-full border-2 border-gray-300 rounded-lg overflow-hidden">
        {card?.imageUrl ? (
          ...
          <button
            ...
            className="w-full h-full flex flex-col items-center justify-center bg-gray-50 hover:bg-gray-100 transition-colors cursor-pointer disabled:cursor-not-allowed"
          >
            {isUploading ? (

        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="card p-6">
              <h2 className="font-cursive text-3xl text-card-text mb-6">
                Order Summary
              </h2>
              ...
              <div className="flex items-center gap-4 pb-4 border-b">
                ...
                />
                <div>
                  <p className="font-cursive text-xl text-card-text">
                    {flowerColor.charAt(0).toUpperCase() + flowerColor.slice(1)} Rose
                    Bouquet
                  </p>
                  <p className="font-cursive text-lg text-gray-500">$80.00</p>
                </div>
              </div>

              {/* Cards */}
              {cards.map((card, index) => (
                <div key={card.id} className="flex items-center gap-4 py-4 border-b">
                  <div className="w-20 h-16 bg-gray-100 rounded flex items-center justify-center">
                    {card.imageUrl ? (
                      ...
                      <span className="font-cursive text-gray-400">Card</span>
                    )}
                  </div>
                  <div className="flex-1">
                    <p className="font-cursive text-lg text-card-text">
                      Letter Card {index + 1}
                    </p>
                    <p className="font-cursive text-sm text-gray-500 truncate">
                      To: {card.recipientName || 'Not specified'}
                    </p>
                  </div>
                  <p className="font-cursive text-lg text-card-text">$5.00</p>
                </div>
              ))}

              {/* Total */}
              <div className="pt-4">
                <div className="flex justify-between font-cursive text-2xl text-card-text">
                  <span>Total</span>
            ...
            <form onSubmit={handleSubmit} className="card p-6">
              ...
              <div className="space-y-4 mb-6">
                <h3 className="font-cursive text-xl text-card-text">Your Information</h3>
                <input
                  type="text"
              ...
              {/* Delivery Address */}
              <div className="space-y-4 mb-6">
                <h3 className="font-cursive text-xl text-card-text">Delivery Address</h3>
                <input
                  type="text"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <input
                    ...
                    required
                    className="p-3 border rounded-lg font-cursive text-lg focus:border-deep-red outline-none"
                  />
                  <input
                    type="text"
                    placeholder="State"
              ...
              {/* Delivery Date */}
              <div className="space-y-4 mb-6">
                <h3 className="font-cursive text-xl text-card-text">Delivery Date</h3>
                <input
                  type="date"
                ...
                />
                {deliveryInfo.date && (
                  <p className="font-cursive text-gray-500">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full btn-pill text-2xl py-4 bg-deep-red text-white hover:bg-red-800 disabled:opacity-50 disabled:cursor-not-allowed"
              >
